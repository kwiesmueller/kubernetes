		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"fieldManager": {
						SchemaProps: spec.SchemaProps{
							Description: "FieldManager is a name associated with the actor or entity that is responsible for the currently taking place interaction with the object. This field is write-only, non-persisted and optional. It is only used by the apiserver on create, apply and update operations, to set the ManagedFields accordingly. The value must be unset or less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.\n\nIf the field is unset, the apiserver will default to the request user-agent. If the request contains the fieldManager option, it takes precedence and this field will be ignored. If neither this field or the requests fieldManager option are set, the apply operation will fail, the non-apply operation won't.\n\nThis field is alpha and can be changed or removed without notice.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
